window.onload = function(){
        ...
        layerFive.style.webkitTransform = 'translateX(' + pageX/30 + '%) translateY(' + pageY/-20 + '%)';
        layerFive.style.transform = 'translateX(' + pageX/30 + '%) translateY(' + pageY/-20 + '%)';                wrapper.style = 'background-position:'+ pageX/200 +'px center';
        });
}
